...
namespace OpenHackLAX
{
    ...
    /// </summary>
    public class OpenHackLAXAccessors
    {
        /// <summary>
        ...
        public OpenHackLAXAccessors(ConversationState conversationState)
        {
        ...
        public static string CounterStateName { get; } = $"{nameof(OpenHackLAXAccessors)}.CounterState";
